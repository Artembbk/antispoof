...
import antispoof.augmentations
import antispoof.datasets
from antispoof import batch_sampler as batch_sampler_module
from antispoof.collate_fn.collate import collate_fn
...
def get_dataloaders(configs: ConfigParser):
    ...
    for split, params in configs["data"].items():
        ...
        if split == 'train':
            wave_augs, spec_augs = antispoof.augmentations.from_configs(configs)
            drop_last = True
        else:
        ...
        for ds in params["datasets"]:
            datasets.append(configs.init_obj(
                ds, antispoof.datasets, config_parser=configs,
